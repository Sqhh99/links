...
class ConferenceBackend : public QObject
{
    ...
    Q_PROPERTY(QString meetingNo READ meetingNo NOTIFY meetingNoChanged)
...
public:
    ...
    Q_INVOKABLE void initialize(const QString& url,
                                const QString& token,
...
private:
    ...
    bool showScreenShareInMain_{true};
